...
Task manager build with VueJS, TailwindCSS and AWS Amplify.
With this task manager you can create projects and within that project you can create tasks. The task status can be toggled when clicking on a task. 
